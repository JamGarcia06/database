...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 18, 2026 at 02:42 PM
...
CREATE TABLE `admin_acc` (
  ...
  `store_name` varchar(100) NOT NULL DEFAULT '''My Food Store''',
...
INSERT INTO `admin_acc` (`id`, `name`, `email`, `password`, `role`, `store_name`, `store_image`) VALUES
(1, 'Administrator', 'admin@gmail.com', 'admin123', 'admin', '\'Pera Pera store\'', '');
...
(5, 'Fried Chicken', 'chicken pero Fried', '50.00', 12, 'available');
...
(13, 1, 5, 5, '2026-08-18 06:22:15', 'Pending');
